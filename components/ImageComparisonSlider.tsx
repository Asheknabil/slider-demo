...
export default function ImageComparisonSlider({
  ...
  return (
    <>
      ...
      <div
        ref={containerRef}
        className={`ics-root ics-grain relative overflow-hidden select-none touch-none ${isDragging ? "ics-dragging" : ""} ${className}`}
        style={{ width: "100%", height, cursor: isDragging ? "col-resize" : "default" }}
